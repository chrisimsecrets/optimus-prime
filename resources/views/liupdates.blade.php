                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Linkedin Companies</h3>
                            ...
                            <div class="box-body no-padding">
                                <ul class="users-list clearfix">
                                    @foreach ($companies as $company)
                                        <li>
                                            <img src="{{ $company['logoUrl'] }}" alt="User Image">
                                            <a class="users-list-name" target="_blank"
                                               href="https://www.linkedin.com/company/{{ $company['id'] }}">{{ $company['name'] }}</a>
                                            <span class="users-list-date">{{ $company['numFollowers'] }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
